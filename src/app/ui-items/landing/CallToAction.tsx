    ...
    return (
        <section className="bg-white dark:bg-purple-600 py-6 lg:py-12">
            <div className="max-w-screen-xl mx-auto">
                <div className="flex-col flex items-center space-y-6 text-center py-6 px-4">
                    ...
                    <Link href="/waitlist" className="inline-block px-8 py-4 text-base font-semibold text-white bg-purple-600 rounded-lg border-2 border-white hover:border-purple-600 transition-colors duration-200 hover:bg-white hover:text-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">
                        Join Waitlist
                    </Link>
                </div>
            </div>
